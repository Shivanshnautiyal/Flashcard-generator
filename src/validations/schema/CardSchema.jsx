/* now here in this file we are setting the valadition schema rules for form for the user using the yup 
...
const FlashCardSchema = Yup.object().shape({
  ...
  cards: Yup.array().of(
    Yup.object().shape({
      cardid: Yup.string(),
      cardname: Yup.string()
        .max(21, "Must be less than 20 characters")
        .min(5, "Group Name Must be More Than 5 Characters")
        .required(" Input Required !"),
      carddescription: Yup.string()
        .min(21, "Must be more than 20 characters")
